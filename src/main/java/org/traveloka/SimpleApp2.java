...
public class SimpleApp2 {
  ...
  private static final DateTime date = new DateTime(System.currentTimeMillis());
  private static final String dateString = date.getYear() + "-" + date.getMonthOfYear() +
          "-" + date.getDayOfMonth();
  ...
  public static void main(String args[]) throws Exception {
    ...
    kafkaParams.put("auto.commit.interval.ms", "30000");
    ...
    JavaStreamingContext jscc = new JavaStreamingContext(conf, new Duration(3600000));
...
//    lines.print();
    ...
    lines.foreachRDD(new Function<JavaRDD<String>, Void>() {
      ...
      public Void call(JavaRDD<String> stringJavaRDD) throws Exception {
        stringJavaRDD.saveAsTextFile("s3n://mongodwh/spark-backup/" + dateString + "/partition-" + partition);
        partition += 1L;
        return null;
      }
    });
